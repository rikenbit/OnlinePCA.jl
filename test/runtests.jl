...
out_oja3 = oja(input="$(tmp)/Data.zst", dim=3, scheduling="nag", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
out_oja4 = oja(input="$(tmp)/Data.zst", dim=3, scheduling="adagrad", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
...
out_ccipca1 = ccipca(input="$(tmp)/Data.zst", dim=3, stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
...
out_rsgd1 = rsgd(input="$(tmp)/Data.zst", dim=3, scheduling="robbins-monro", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
out_rsgd2 = rsgd(input="$(tmp)/Data.zst", dim=3, scheduling="momentum", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
out_rsgd3 = rsgd(input="$(tmp)/Data.zst", dim=3, scheduling="nag", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
out_rsgd4 = rsgd(input="$(tmp)/Data.zst", dim=3, scheduling="adagrad", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
...
out_svrg1 = svrg(input="$(tmp)/Data.zst", dim=3, scheduling="robbins-monro", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
out_svrg2 = svrg(input="$(tmp)/Data.zst", dim=3, scheduling="momentum", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
out_svrg3 = svrg(input="$(tmp)/Data.zst", dim=3, scheduling="nag", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
out_svrg4 = svrg(input="$(tmp)/Data.zst", dim=3, scheduling="adagrad", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
...
out_rsvrg1 = rsvrg(input="$(tmp)/Data.zst", dim=3, scheduling="robbins-monro", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
out_rsvrg2 = rsvrg(input="$(tmp)/Data.zst", dim=3, scheduling="momentum", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
out_rsvrg3 = rsvrg(input="$(tmp)/Data.zst", dim=3, scheduling="nag", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
out_rsvrg4 = rsvrg(input="$(tmp)/Data.zst", dim=3, scheduling="adagrad", stepsize=1.0e-15, numepoch=1, rowmeanlist="$(tmp)/Feature_FTTMeans.csv", logdir=tmp)
